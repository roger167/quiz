...
class QuestionnairesControllerTest < ActionController::TestCase
  ...
  test "should create questionnaire" do
    assert_difference('Questionnaire.count') do
      post :create, questionnaire: { answerUser: @questionnaire.answerUser, eval: @questionnaire.eval, idquestion: @questionnaire.idquestion }
    end
  ...
  test "should update questionnaire" do
    patch :update, id: @questionnaire, questionnaire: { answerUser: @questionnaire.answerUser, eval: @questionnaire.eval, idquestion: @questionnaire.idquestion }
    assert_redirected_to questionnaire_path(assigns(:questionnaire))
  end
